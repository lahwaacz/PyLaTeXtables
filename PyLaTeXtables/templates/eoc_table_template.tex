...
((* set tabular_columns = 'r' * index_columns + 'r' * ( data_columns % 2 ) + 'rc' * ( data_columns // 2 ) *))
((* set np_digits = 2 *))
    ...
    ((* for x in row -*))
        ...
        ((* if "eoc" in _row_label.lower() -*))
            ((* if not loop.last -*))
                ...
                \shiftright{0pt}{\bf ((( x | np(np_digits, maybe_int=False) if x | string != "nan" )))}((( '  &  ' if loop.revindex0 > 1 )))
            ((*- endif *))
